defmodule Poxa.PresenceSubscriptionTest do
  ...
  test "subscribe to a presence channel" do
    ...
    assert subscribe!("app_id", "presence-channel", "{ \"user_id\" : \"id123\", \"user_info\" : \"info456\" }") == %PresenceSubscription{channel: "presence-channel", channel_data: [user, other_user]}
  ...
  test "subscribe to a presence channel already subscribed" do
    ...
    assert subscribe!("app_id", "presence-channel", "{ \"user_id\" : \"id123\", \"user_info\" : \"info456\" }") == %PresenceSubscription{channel: "presence-channel", channel_data: [user]}
  ...
  test "unsubscribe to presence channel being subscribed" do
    ...
    assert unsubscribe!("app_id", "presence-channel") == {:ok, "presence-channel"}
    assert validate PusherEvent
    assert validate :gproc
  end
  ...
  test "check subscribed presence channels and remove having only one connection on userid" do
    ...
    assert check_and_remove("app_id") == :ok
